...
import com.example.ari.protogui.DataBaseHelper;
import com.example.ari.protogui.LocationChain;
import com.example.ari.protogui.R;
                    ...
                    temptextview.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if(ll.isEnabled()){
                                ll.setEnabled(0);
                                //pretty green
                                db.updateLocation(ll.id, ll.enabled);

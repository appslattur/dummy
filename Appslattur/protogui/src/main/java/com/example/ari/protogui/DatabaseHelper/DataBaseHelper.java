package com.example.ari.protogui.DatabaseHelper;
...
class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void populateTable(){
        ...
        newLocation(templong, templat, subway, "1");
        newLocation(templong, templat, subway, "1");
        newLocation(templong, templat, subway, "1");
        newLocation(templong, templat, subway, "1");
        newLocation(templong, templat, subway, "1");

        newLocation(templong, templat, tolvutek, "1");

        newLocation(templong, templat, start, "1");

        newLocation(templong, templat, bootcamp, "1");

        newLocation(templong, templat, worldclass, "1");
        newLocation(templong, templat, worldclass, "1");
        newLocation(templong, templat, worldclass, "1");
        newLocation(templong, templat, worldclass, "1");

        newLocation(templong, templat, bullan, "1");
        newLocation(templong, templat, bullan, "1");
        newLocation(templong, templat, bullan, "1");
        newLocation(templong, templat, bullan, "1");
        newLocation(templong, templat, bullan, "1");
        ...
        newLocation(templong, templat, serrano, "1");
        newLocation(templong, templat, serrano, "1");
        newLocation(templong, templat, serrano, "1");
        newLocation(templong, templat, serrano, "1");
        newLocation(templong, templat, serrano, "0");
        newLocation(templong, templat, serrano, "0");
        newLocation(templong, templat, serrano, "0");
        newLocation(templong, templat, serrano, "1");
        newLocation(templong, templat, serrano, "1");
